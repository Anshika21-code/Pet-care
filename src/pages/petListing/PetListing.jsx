        ...
        <div className='flex flex-col items-center w-full '>
         ...
         <div>
          ...
          <select
            ...
            className='block ml-2 p-2 rounded border border-solid border-neutral-300 bg-white bg-clip-border text-base font-normal leading-[1.6] text-black-700 outline-none transition duration-200 ease-in-out focus:z-[3] focus:border-primary focus:text-black-700 focus:shadow-[inset_0_0_0_1px_rgb(59,113,202)] focus:outline-none dark:border-neutral-600 dark:text-neutral-200 dark:placeholder:text-black-200 dark:focus:border-primary'
          >
