              ...
              <div className="w-full">
                ...
                <div className="input flex justify-end mb-5">
                  ...
                  <label htmlFor="file-upload" className="custom-file-upload ">
                    {image ? (
                      <img className="w-10 lg:w-10 rounded-xl" src={URL.createObjectURL(image)} alt="img" />
                    ) : (
                      <img src="https://cdn-icons-png.flaticon.com/128/1665/1665680.png" className="w-10" />
                    )}
                  </label>
                  <input
                    id="file-upload"
